...
const DetailsModal = ({ id, setOpenModal }) => {
    ...
    return (
        ...
        >
            <div className="relative overflow-y-auto rounded-2xl w-full max-w-2xl h-4/5 border border-[#35aac7]/60 bg-gradient-to-br from-[#020617] via-[#020617] to-[#020617] shadow-[0_25px_70px_rgba(15,23,42,0.95)]">
                <button
