...
import resume from '../../assets/rana-ahmed-resume.pdf'
...
const NavItems = ({activeSection, setOpen}) => {
    return (
        <>
            ...
            <li>
                <a download href={resume} className="ml-0 mt-5 md:mt-0 md:ml-5 relative inline-flex items-center justify-center px-5 py-2 font-medium text-white bg-gray-800 rounded-lg group bg-gradient-to-br from-purple-600 to-blue-500">
