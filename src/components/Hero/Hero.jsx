    ...
    return (
        <div className="hero">
            <div className="h-[calc(100vh-80px)] max-w-7xl px-4 md:px-10 mx-auto flex flex-col-reverse md:flex-row justify-center md:justify-between items-center">
                <div className="w-full md:w-3/5 py-3 overflow-hidden"
                data-aos="fade-up"
                data-aos-offset="200"
                data-aos-delay="50"
                ...
                >
                    ...
                    <TypeAnimation
                        className='text-4xl md:text-[50px] poppins-font font-bold text-gray-100'
                        sequence={[
                            "I'm Rana Sheikh",
                            1000,
                    ...
                    <div>
                        <ScrollLink to="projects" smooth={true} duration={500} offset={-80}>
                            <button data-aos="fade-up-right" data-aos-delay="600" data-aos-duration="1200" data-aos-offset="50" className="px-7 py-3 mr-5 relative inline-flex items-center justify-center font-medium text-white bg-gray-800 rounded-lg group bg-gradient-to-br from-purple-600 to-blue-500 group">
                        ...
                        <ScrollLink to="contact" smooth={true} duration={500} offset={-80}>
                            <button data-aos="fade-up-left" data-aos-delay="600" data-aos-duration="1200" data-aos-offset="50" className="relative inline-flex items-center justify-center px-6 py-3 overflow-hidden font-medium text-[#6f54ef] transition duration-300 ease-out border-2 border-[#6f54ef] hover:border-transparent rounded-lg group">
